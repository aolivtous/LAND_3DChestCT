...
class SpatialTransformer3D(nn.Module):
    ...
    def forward(self, x, context=None):
        ...
        # flatten spatial dimensions: (D*H*W)
...
def SpatialTransformer_nd(dims, *args, **kwargs):
    if dims == 2:
        return SpatialTransformer(*args, **kwargs)
    elif dims == 3:
        return SpatialTransformer3D(*args, **kwargs)
